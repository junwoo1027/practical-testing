...
public class ProductControllerDocsTest extends RestDocsSupport {
    ...
    void createProduct() throws Exception {
        CreateProductRequest request = new CreateProductRequest(ProductType.BOTTLE, ProductSellingStatus.SELLING, "아메리카노", 4000);

        given(productService.createProduct(any(CreateProductServiceRequest.class)))
